      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-8 items-end">
        ...
        >
          <div className="aspect-square mb-4 overflow-hidden rounded bg-white flex items-center justify-center p-4 border border-border-subtle/50">
            <ProductImage className="object-contain max-h-full max-w-full transition-transform duration-300 group-hover:scale-105" alt={`${a.brand} ${a.model} karşılaştırma görseli`} src={imgA} width={320} height={320} decoding="async" />
          </div>
        ...
        >
          <div className="aspect-square mb-4 overflow-hidden rounded bg-white flex items-center justify-center p-4 border border-border-subtle/50">
            <ProductImage className="object-contain max-h-full max-w-full transition-transform duration-300 group-hover:scale-105" alt={`${b.brand} ${b.model} karşılaştırma görseli`} src={imgB} width={320} height={320} decoding="async" />
          </div>
